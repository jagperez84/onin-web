-- Compatibilidad PostgreSQL: jsonb_object_length no está disponible en el runtime.
-- La función de materialización ya existe en la migración anterior; esta migración
-- mantiene la corrección aplicada en bases que ya ejecutaron esa versión.
