...
do $$ declare t text; begin foreach t in array array['otd_component','otd_selection','otd_selection_option','otd_variable','otd_version'] loop execute format('alter table public.%I enable row level security',t); end loop; end $$;
