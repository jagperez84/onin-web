...
import { Users, Package, FileText, Warehouse, Ruler, Hammer, ReceiptText, Factory, Settings, Settings2, ArrowRightLeft, CalendarClock, UserCog, SlidersHorizontal, Map, CreditCard, Handshake, HardHat, Layers, Palette, PaintBucket, Wrench, ClipboardCheck, BarChart3, ShieldCheck } from "lucide-react";
...
export const navSections: NavSection[] = [
 ...
 {label:"Configuración",items:[{label:"Usuarios",to:"/configuracion/usuarios",icon:<UserCog size={16}/>},{label:"Tipos de montaje",to:"/configuracion/tipos-montaje",icon:<Wrench size={16}/>},{label:"Formas de pago",to:"/configuracion/formas-pago",icon:<CreditCard size={16}/>},{label:"Condiciones de pago",to:"/configuracion/condiciones-pago",icon:<Handshake size={16}/>},{label:"Auditoría",to:"/configuracion/auditoria",icon:<ShieldCheck size={16}/>} ]},
];
