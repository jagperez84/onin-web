...
import { Users, Package, FileText, Warehouse, Ruler, Hammer, ReceiptText, Factory, Settings, Settings2, ArrowRightLeft, CalendarClock, UserCog, SlidersHorizontal, Map, CreditCard, Handshake, HardHat, Layers, Palette, PaintBucket, Wrench, ClipboardCheck } from "lucide-react";
