...
import { MeasurementTypesV1 } from '../modules/catalog/MeasurementTypesV1';
...
import { OtdDetail } from '../modules/otd/OtdDetail';
...
function Shell() {
  ...
  if (!current) {
    ...
    else if (location.pathname.startsWith('/configuracion/tipos-medida')) title = 'Tipos de medida';
...
function HomeView() {
  ...
  const cards = [['Clientes', 'Gestión de clientes', '/ventas/clientes'], ['Artículos', 'Catálogo de productos', '/ventas/articulos']];
