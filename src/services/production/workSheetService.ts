...
export type WorkSheet = { id:number; company_id:number; code:string; document_type:'PROFILE_CUT'; issue_date:string; status:WorkSheetStatus; sales_order_id:number|null; sales_order_line_id:number|null; sales_order_line_no:number|null; sales_order_code?:string|null; product_id:number|null; product_code:string|null; product_name:string|null; characteristic_id:number|null; characteristic_code:string|null; characteristic_name:string|null; color_id:number|null; color_code:string|null; color_name:string|null; required_length:number; quantity:number; unit_symbol?:string|null; unit_code?:string|null; reference:string|null; notes:string|null; selection_mode:string|null; selection_reason:string|null; created_by:string|null; lines:WorkSheetLine[]; };
