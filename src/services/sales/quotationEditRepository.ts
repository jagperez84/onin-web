  ...
  const lines = ((q.lines ?? []) as any[])
    ...
    .map(line => ({
      ...
      characteristics: (line.characteristics ?? []).map((ch: any) => ({
        ...
        color_id: ch.color_id == null ? null : Number(ch.color_id),
      })),
