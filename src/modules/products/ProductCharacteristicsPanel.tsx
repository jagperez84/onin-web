...
export function ProductCharacteristicsPanel({productId,readOnly,onError}:Props){
  ...
  return <section className="panel product-characteristics-panel">
    <div className="panel-head"><div><h2>Características / colores</h2><p>Variantes del artículo. Cada característica puede tener sus propios valores comerciales y de stock.</p></div>{!readOnly&&<button type="button" className="secondary-button compact" onClick={startNew}><Plus size={15}/> Añadir característica</button>}</div>
