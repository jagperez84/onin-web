...
export function ProductCharacteristicsPanel({productId,readOnly,onError}:Props){
  ...
  useEffect(()=>{if(readOnly){setSectionEditing(false);setEditing(null);setForm({...emptyForm});}},[readOnly]);
