...
const articles: HelpArticle[] = [
  ...
  },
  {
    ...
    status: "Disponible",
    steps: [
      "Entra en Ventas > Artículos > Configuración de artículos y selecciona «Comportamientos de línea».",
      ...
      "Asigna esta línea de comportamiento a la familia correspondiente, y marca ahí Confeccionable y/o Recortable según corresponda, en Ventas > Artículos > Familias.",
    ],
    warnings: [
