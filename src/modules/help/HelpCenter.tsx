...
const articles: HelpArticle[] = [
  ...
  },
  {
    ...
    status: "Disponible",
    steps: [
      "Entra en Catálogo > Artículos para consultar el catálogo.",
  ...
  },
  {
    ...
    steps: [
      "Abre un artículo desde Catálogo > Artículos y accede a sus características cuando estén disponibles.",
  ...
  },
  {
    ...
    summary: "Define qué campos necesita cada familia de artículos (toldos, pérgolas, piscinas…) en su línea de presupuesto; el corte de lona/perfiles lo activa la propia familia (Confeccionable/Recortable).",
    section: "Catálogo",
    icon: Layers,
    route: "/ventas/articulos/configuracion",
    keywords: ["comportamiento de línea", "familia", "corte", "rollo", "costura", "barra", "perfil", "OTD", "confeccionable", "recortable"],
    status: "Disponible",
    steps: [
      "Entra en Catálogo > Artículos > Configuración de artículos y selecciona «Comportamientos de línea».",
      "Activa solo los campos que esa línea necesita realmente en el presupuesto: cantidad, precio, descuento, dimensiones, configuración o características.",
      "Los parámetros de corte (ancho de rollo, márgenes de dobladillo y vaina, longitud de barra estándar) se aplican cuando la familia que use esta línea sea Confeccionable o Recortable; si los dejas en blanco, se usan los valores por defecto de un toldo enrollable.",
      ...
      "Asigna esta línea de comportamiento a la familia correspondiente, y marca ahí Confeccionable y/o Recortable según corresponda, en Catálogo > Artículos > Familias.",
    ],
    warnings: [
      "El motor de corte solo modela piezas rectangulares. Para artículos con formas irregulares (recortes, esquinas no rectas) desmarca Confeccionable/Recortable en la familia y usa el despiece (componentes del OTD) para registrar solo la cantidad total de material.",
  ...
  },
  {
    ...
    status: "Disponible",
    steps: [
      "Entra en Catálogo > Tipos de medida.",
