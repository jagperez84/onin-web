...
export function SalesOrderDetail(){
 ...
 return <div className="module-page sales-order-detail-page">
  ...
  {lonaLine&&<LonaConfectionModal line={lonaLine} companyId={companyId} reference={`${data.code} · Línea ${lonaLine.line_no}`} onClose={()=>setLonaLine(null)}/>} 
