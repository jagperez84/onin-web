  ...
  return (
    <div className="module-page">
      <div className="page-head">
        <div>
          <div className="eyebrow">VENTAS / CLIENTES</div>
          <h1>Listado de Clientes</h1>
          <p>Consulta y gestión de clientes.</p>
        </div>
        <Link className="primary-button" to="/ventas/clientes/nuevo">
      ...
      <div className="toolbar">
        <div className="search-box">
          ...
          <input
            ...
            placeholder="Buscar por nombre, CIF/NIF o código…"
              ...
              rows.map((r) => {
                ...
                return (
                  <tr key={r.id} className="clickable-row">
                    ...
                    <td>{r.party.tax_id || "—"}</td>
                    <td>{r.party.phone || "—"}</td>
                    <td>{r.party.email || "—"}</td>
                    <td>
                      <span
                        className={`status ${deleted ? "inactive" : r.party.active ? "active" : "inactive"}`}
                      >
                        {deleted
