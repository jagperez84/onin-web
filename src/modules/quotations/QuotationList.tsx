...
export function QuotationList(){
  ...
  return <div className="module-page"><div className="page-head"><div><div className="eyebrow">VENTAS / PRESUPUESTOS</div><h1>Listado de Presupuestos</h1><p>Consulta y gestión de presupuestos.</p></div></div>
