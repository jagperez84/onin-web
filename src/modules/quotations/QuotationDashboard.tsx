...
export function QuotationDashboard(){
  ...
  return <section className="quotation-dashboard" aria-label="Indicadores de presupuestos">
    ...
    <div className="quotation-kpi-grid">
      ...
      <div className="quotation-kpi"><div className="quotation-kpi-icon"><FileText size={18}/></div><div><span>Presupuestado · últimos 12 meses</span><strong>{metrics?money(metrics.lastYearAmount):'—'}</strong><small>Importe total de los presupuestos emitidos en el último año.</small></div></div>
