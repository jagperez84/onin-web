 ...
 return <div className="module-page quotation-page">
   ...
   <section id="lineas" className="quotation-lines-section quotation-anchor">
     ...
     <div className="quotation-lines-layout">
       ...
       <aside className="quotation-totals-card"><div><span>Neto</span><strong>{money(Number(data.net_amount||0))}</strong></div><div><span>Descuento</span><strong>{money(Number(data.discount_amount||0))}</strong></div><div><span>IVA</span><strong>{money(Number(data.tax_amount||0))}</strong></div><div className="quotation-total-final"><span>Total</span><strong>{money(Number(data.total_amount||0))}</strong></div></aside>
     </div>
   </section>
